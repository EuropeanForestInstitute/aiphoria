...
preparing greenhouse gas reports for land use, land-use change
and forestry (LULUCF), who often work in spreadsheets rather
...
General DMFA frameworks such as ODYM [@Pauliuk2020] and flodym
...
of the Intergovernmental Panel on Climate Change (IPCC) guidelines
[@IPCC2019]. The default method starts from production
...
IPCC approach with mass-balanced material flow analysis find that following end uses can give
...
`aiphoria` was initially developed by the European Forest Institute (EFI) and the
